class ImportSlides < ActiveRecord::Migration
  def self.up
    ...
    :of_slide => 1)
    Content.create(:json => '{"c":"","a":[{"o":"e700","p":{"f":"blind","direction":"horizontal"}},{"o":"e701","p":{"f":"slide"}},{"o":"e702","p":{"f":"puff"}}],"t":{"f":"puff"},"e":[{"i":"e700","t":"p","c":"<p align=\"center\"><font face=\"arial\" size=\"3\"><b id=\"ext-gen919\"><font id=\"ext-gen867\">This is the title of our demo presentation</font></b></font></p>","p":{"left":"0.1%","fontSize":"100%","height":"5.69%","fontClass":"A","top":"5.94%","width":"99.59%"}},{"i":"e701","t":"p","c":"<p id=\"ext-gen866\" align=\"center\"><font id=\"ext-gen904\" face=\"arial\" size=\"3\">Slide 1</font></p>","p":{"left":"0.02%","fontSize":"100%","height":"5.69%","fontClass":"A","top":"0.83%","width":"99.8%"}},{"i":"e702","t":"img","c":{"src":"http://farm4.static.flickr.com/3176/2571457016_064561db6a.jpg"},"p":{"left":"9.6%","height":"81.03%","top":"12.81%","width":"80.53%"}}],"p":{"backgroundColor":"#FFFFFF"}}',
    :of_slide => 2)
