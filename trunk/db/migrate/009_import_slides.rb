class ImportSlides < ActiveRecord::Migration
  def self.up
    ...
    #Presentation 2
    Content.create(:json => '{"t":[null,null],"p":{"backgroundColor":"black","color":"white"},"e":{"ea":{"t":"img","c":{"src":"/user_doc/cgonnet/media/bg.png"},"p":{"top":"0%","left":"0%","width":"100%","height":"100%"}},"e0":{"t":"img","c":{"src":"/user_doc/cgonnet/media/tQuery_logo.gif"},"p":{"top":"33%","left":"19%","width":"14%","height":"10.5%"}},"e1":{"t":"span","c":"","p":{"top":"50%","left":"10%","width":"80%","height":"1%","backgroundColor":"#808080"}},"e2":{"t":"h2","c":"jQuery","p":{"top":"39%","left":"0%","width":"100%","fontSize":"250%","textAlign":"center"}},"e3":{"t":"p","c":"BostonPHP - June 2008<br/>John Resig (ejohn.org)","p":{"top":"55%","width":"100%","textAlign":"center"}}},"a":[{"o":"ea"},{"o":"e0"},{"o":"e1"},{"o":"e2"},{"o":"e3"}]}',
    :of_slide => 6)
    Content.create(:json => '{"m":"m1","t":[null,null],"e":{"e0":{"t":"h2","c":"What is jQuery?","p":{"top":"10%","left":"10%","fontSize":"200%"}},"e1":{"t":"ul","c":"<li>An open source JavaScript library that<br />simplifies the interaction between HTML<br />and JavaScript.","p":{"top":"26%","left":"10%"}}},"a":[{"o":"e0"},{"o":"e1"}]}',
    :of_slide => 7)
    Content.create(:json => '{"m":"m1","t":[null,null],"e":{"e0":{"t":"h2","c":"Keep Clean","p":{"top":"10%","left":"10%","fontSize":"200%"}},"e1":{"t":"ul","c":"<li>jQuery can rename \'$\':<br />var $jq = jQuery.noConflict();<br/>$jq(“div”).hide();<li>jQuery can even rename \'jQuery\' allowing<br />multiple copies to run side-by-side.<li>var $a = jQuery.noConflict(true);<br/>// load other version of jQuery$a(“div”).hide(); // still works!","p":{"top":"26%","left":"10%"}}},"a":[{"o":"e0"},{"o":"e1","f":"li:eq(2)","p":"hide"},{"o":"e1","n":"click"},{"o":"e1","f":"li:eq(2)","p":{"f":"fade"}}]}',
    :of_slide => 8)
