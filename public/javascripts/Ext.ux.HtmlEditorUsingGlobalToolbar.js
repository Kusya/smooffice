...
var App = function(){
	...
	return {
		init: function(){
			...
			App.GlobalHtmlEditorToolbar = new Ext.ux.HtmlEditorToolbar({
				renderTo: Ext.DomQuery.selectNode('#htmlEditorToolbar')
				,enableFormat : true
			    ,enableFontSize : true
			    ,enableColors : true
			    ,enableAlignments : true
			...
			var textEl = Ext.get(Ext.DomQuery.selectNode('#htmlEditordiv1'));
			...
			textEl.on(
				...
				,function(){
					...
					this.editor = new Ext.ux.HtmlEditorUsingGlobalToolbar({
						globalToolBar: App.GlobalHtmlEditorToolbar
					...
					this.hide();
					this.dom.innerHTML = '';
					this.editor.render(textEl.dom)
					this.show();
				}
				,textEl
			);

			var editor2 = new Ext.ux.HtmlEditorUsingGlobalToolbar({
				globalToolBar: App.GlobalHtmlEditorToolbar
				,renderTo: Ext.DomQuery.selectNode('#htmlEditordiv2')
			});
			
			var editor3 = new Ext.ux.HtmlEditorUsingGlobalToolbar({
				globalToolBar: App.GlobalHtmlEditorToolbar
				,renderTo: Ext.DomQuery.selectNode('#htmlEditordiv3')
			});
