;(function($) {
  ...
  $.effects.fold = function(o) {
    ...
    return this.queue(function() {
      ...
      // Animate
      wrapper.animate(animation1, {queue: o.options.queue || false, duration: o.duration / 2, easing: o.options.easing})
      .animate(animation2, {queue: o.options.queue || false, duration: o.duration / 2, easing: o.options.easing, complete: function(){
  		if (mode == 'hide') 
  			el.hide(); // Hide
